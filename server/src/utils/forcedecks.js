...
const METRICS = [
  ...
  { key: "concentric_impulse_at_100ms", label: "Conc. Impulse @ 100ms", unit: "N·s", coachOnly: true },
  ...
  { key: "concentric_rfd", label: "Conc. RFD", unit: "N/s", coachOnly: true },
  ...
  { key: "eccentric_peak_velocity", label: "Ecc. Peak Velocity", unit: "m/s", coachOnly: true },
  { key: "force_at_zero_velocity", label: "Force @ 0 Velocity", unit: "N", coachOnly: true },
